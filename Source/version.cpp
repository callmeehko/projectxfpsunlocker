...
{
	if (HINTERNET internet = InternetOpenA("callmeehko/projectxfpsunlocker", INTERNET_OPEN_TYPE_PRECONFIG, NULL, NULL, NULL))
	{
...
bool CheckForUpdates()
{
	...
	{
		char buffer[256];
		sprintf_s(buffer, "A new version of ProjectX FPS Unlocker is available.\n\nCurrent Version: %s\nLatest Version: %s\n\nVisit download page?", RFU_VERSION, latest_version.c_str());
