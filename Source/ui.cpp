...
#ifdef _WIN64
	SetConsoleTitleA("ProjectX FPS Unlocker " RFU_VERSION " (64-bit) Console");
#else
	SetConsoleTitleA("ProjectX FPS Unlocker " RFU_VERSION " (32-bit) Console");
#endif
...
{	
	...
	UI::Window = CreateWindow("RFUClass", "ProjectX FPS Unlocker", 0, 0, 0, 0, 0, NULL, NULL, instance, NULL);
	if (!UI::Window)
		return 0;
	...
	strcpy_s(NotifyIconData.szTip, "ProjectX FPS Unlocker");
